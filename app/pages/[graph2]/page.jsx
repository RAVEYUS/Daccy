...
import { dockerNodes as dockerMethodsData } from "@/lib/dockerMethods"; // Correct reference to dockerNodes
...
export default function ArrayMethodsExplorer() {
  ...
  const nodes = useMemo(() => dockerMethodsData, []);
  ...
  const fetchAIResponse = async (topic) => {
    try {
      ...
      setAiResponses((prev) => ({
        ...prev,
        [topic]: "Sorry, an error occurred while fetching the response.",
      }));
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto py-10">
        <h1 className="text-3xl font-bold mb-6">Docker</h1>
              ...
              >
                <Card className="h-full flex flex-col">
                  ...
                  <CardContent className="flex-grow overflow-hidden flex flex-col">
                    ...
                    <div className="mt-4">
                      <Button onClick={() => setIsChatOpen(!isChatOpen)} className="w-full">
                        <MessageCircle className="mr-2 h-4 w-4" />
                        {isChatOpen ? "Close Chat" : "Open Chat"}
                      </Button>
                    </div>
                    {isChatOpen && (
                      <div className="mt-4 border-t pt-4 flex flex-col h-64">
