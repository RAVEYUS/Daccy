    ...
    <div className="min-h-screen bg-black text-white flex flex-col relative">
      ...
      <nav className="bg-yellow-500 text-black p-4 sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold">Pac-Debug</Link>
      ...
      <header className="py-20 text-center relative z-10">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl mb-6 text-yellow-400 font-bold">Pac-Debug: Chomp Away Those Bugs!</h1>
      ...
      <section id="features" className="py-20 bg-gray-900 bg-opacity-80 relative z-10">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl mb-12 text-center text-yellow-400 font-bold">Power-Ups for Your Coding Journey</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard 
              icon={<CodeIcon className="w-12 h-12 text-blue-400" />}
              title="Multi-Language Support"
              description="Debug in Python, JavaScript, Java, and more. Expand your skills across various programming languages."
            />
            <FeatureCard 
              icon={<ZapIcon className="w-12 h-12 text-green-400" />}
              title="Real-Time Feedback"
              description="Get instant feedback on your bug fixes. Learn from your mistakes and improve rapidly."
            />
            <FeatureCard 
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-8 md:mb-0">
              <h3 className="text-2xl text-yellow-400 font-bold mb-4">Pac-Debug</h3>
...
function FeatureCard({ icon, title, description }:any) {
  return (
    <div className="bg-gray-800 p-6 rounded-lg text-center transition-transform hover:scale-105">
